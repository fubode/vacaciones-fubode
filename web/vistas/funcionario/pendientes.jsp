...
<html>
                ...
                <div class="col-12">
                    <nav class="site-navigation text-right ml-auto " role="navigation">
                        <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                            ...
                            <li class="sombra"><a href="srvUsuario?accion=pendientes" class="nav-link">SOLICITUDES PENDIENTES</a></li>
        ...
        <tbody>
            ...
            <c:forEach var="dato" items="${pendientes}">
                <tr>
                    ...
                    <td>
                        <button type="button" id="${dato.codigo_solicitud}" class="btn btn-danger anularSolicitud">
                            ANULAR
                        </button>                         
                    </td>
                </tr>
    ...
    <script src="js/funcionario/anularSolicitud.js" type="text/javascript"></script>
</body>
</html>
