...
<html>
    <head>
        ...
        <title>SGV-FUBODE | SOLICITUDES RECHAZADAS</title>
    </head>
    <body>
        <div class="linea"></div>
                ...
                <c:forEach var="dato" items="${lista_rechazados}">
                    <tr>
                        ...
                        <td class="d-flex justify-content-center">
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#${dato.codigo_solicitud}"  title="Detalle" data-original-title="Detalle">
                                DETALLE</button>
                            <!-- Modal compensacion -->
