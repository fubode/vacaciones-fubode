...
<html>
                ...
                <div class="col-12">
                    <nav class="site-navigation text-right ml-auto " role="navigation">
                        <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                            ...
                            <li class="sombra"><a href="srvAdministrador?accion=funcionarios" class="nav-link">FUNCIONARIOS</a></li>
            ...
            <div class="modal-content">
                ...
                <div class="container card-body">
                    <div class="card">
                        ...
                        <label class=""><strong> CEDULA DE IDENTIDAD</strong></label>
    ...
    <div class="modal fade" id="editarFuncionario" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="container card-body">
                    <div class="card">
                        ...
                        <div class="input-group  mb-3">
                            ...
                            <input type="number" id="ci_e" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-sm">Expedido</span>
                            </div>
                            <select name="e_expedido" id="e_expedido" class="form-control">
                                <option value="CB">COCHABAMBA</option>
                                <option value="LP">LA PAZ</option>
                                <option value="SC">SANTA CRUZ</option>
                                <option value="OR">ORURO</option>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary m-2" data-dismiss="modal">Cerrar</button>
                    <button type="button" id="editar_f" class="btn fubode-naranja m-2" onclick="editar()" >EDITAR</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="js/administrador/funcionario.js" type="text/javascript"></script>
</body>
</html>