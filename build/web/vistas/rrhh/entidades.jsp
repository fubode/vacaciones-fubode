...
<html>
    <head>
        ...
        <title>SGV-FUBODE | ENTIDADES</title>
    </head>
    <body>
        <div class="linea"></div>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse d-flex jus" id="navbarTogglerDemo03">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="sombra"><a href="srvAdministrador?accion=entidades" class="nav-link">ENTIDADES</a></li>
    ...
    <table id="tablaFubode" class="table container-fluid table-hover table-striped table-bordered ">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <c:forEach var="dato" items="${lista}">
                <tr>
                    <td>${dato.codigo_entidad}</td>
                    <td>${dato.nombre_entidad}</td>
                    <td>${dato.tipo_entidad}</td>
                    <td>${dato.entidad_supervisor}</td>
                    <td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header fubode-azul">
                    <h5 class="modal-title" id="exampleModalLongTitle">AGREGAR NUEVA ENTIDAD</h5>
                ...
                <div class="container card-body">
                    <div class="card">
                        <div class="container">
                            <label class="m-2"><strong>CODIGO ENTIDAD</strong></label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="agregarCargo" class="btn btn-success m-2" onclick="agregar()" >AGREGAR</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="editarEntidadModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header fubode-naranja">
                    <h5 class="modal-title" id="exampleModalLongTitle">EDITAR INFORMACION DE ENTIDAD</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="container card-body">
                    <div class="card">
                        <div class="container">
                            <label class="m-2"><strong>CODIGO ENTIDAD</strong></label>
                            <input type="number" name="codigo" id="codigoEntidad_e" class="form-control" disabled>                    
                        </div>
                        <div class="container mb-4">
                            <label class="m-2"><strong>NOMBRE DEL ENTIDAD</strong></label>
                        ...
                        <div class="container mb-4">
                            <label class=""><strong>ASIGNAR TIPO</strong></label>
                            <select name="tipoEntidad" id="tipoEntidad_e" class="form-control">
                                <option value="SUCURSAL" selected>SUCURSAL</option>
                                <option value="REGIONAL">REGIONAL</option>
                                <option value="AGENCIA">AGENCIA</option>
                                <option value="NACIONAL">NACIONAL</option>
                        ...
                        <div class="container mb-4">
                            <label class=""><strong>ASIGNAR ENTIDAD </strong></label>
                            <select name="entidad" id="entidad_e" class="form-control">
    ...
    <script src="js/administrador/entidades.js" type="text/javascript"></script>
</body>
</html>